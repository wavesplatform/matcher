...
import com.wavesplatform.dex.it.containers.BaseContainersKit
import org.scalatest.{Args, CancelAfterFailure, Status, TestSuite}
...
trait InformativeTestStart extends TestSuite { self: BaseContainersKit =>
  ...
  override protected def runTest(testName: String, args: Args): Status = {
    ...
    super.runTest(testName, args).tap {
      _.whenCompleted {
