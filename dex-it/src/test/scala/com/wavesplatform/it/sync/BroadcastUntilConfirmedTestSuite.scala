...
class BroadcastUntilConfirmedTestSuite extends NewMatcherSuiteBase {
  ...
  private val aliceOrder = prepareOrder(alice, matcher, ethWavesPair, OrderType.SELL, 100000L, 80000L)
  private val bobOrder   = prepareOrder(bob, matcher, ethWavesPair, OrderType.BUY, 200000L, 100000L)
