...
class OrderDeviationsTestSuite extends MatcherSuiteBase {
  ...
  "buy orders price is" - {
    ...
    "in deviation bounds" - {
      for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
        ...
        dex1.api.getOrderBook(assetPair).asks should matchTo(List(HttpV0LevelAgg(2000.waves, 500000)))
        dex1.api.getOrderBook(assetPair).bids should matchTo(List(HttpV0LevelAgg(2000.waves, 300000)))
        ...
        dex1.api.getReservedBalanceByPK(alice) should matchTo(Map(assetPair.amountAsset -> 100000000000L, feeAsset -> 2 * matcherFee))
        dex1.api.getReservedBalanceByPK(bob) should matchTo(Map(assetPair.priceAsset -> 691500000L))
      ...
      s"$wavesUsdPair" in {
        ...
        dex1.api.getOrderBook(wavesUsdPair).asks should matchTo(List(HttpV0LevelAgg(2000.waves, 500)))
        dex1.api.getOrderBook(wavesUsdPair).bids should matchTo(List(HttpV0LevelAgg(2000.waves, 300)))
        ...
        dex1.api.getReservedBalanceByPK(bob) should matchTo(Map(wavesUsdPair.amountAsset -> 100000000000L, feeAsset -> 600L))
        dex1.api.getReservedBalanceByPK(alice) should matchTo(Map(wavesUsdPair.priceAsset -> 691500L))
    ...
    "out of deviation bounds" - {
      "-- too low" - {
        for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
          ...
          dex1.api.getReservedBalanceByPK(bob)(assetPair.priceAsset) shouldBe 300600000L
          ...
          dex1.api.getReservedBalanceByPK(bob) shouldBe Map(assetPair.priceAsset -> 300600000L)
        ...
        s"$wavesUsdPair" in {
          ...
          dex1.api.getReservedBalanceByPK(bob)(wavesUsdPair.priceAsset) shouldBe 300600L
          ...
          dex1.api.getReservedBalanceByPK(bob) shouldBe Map(wavesUsdPair.priceAsset -> 300600L)
  ...
  "sell orders price is" - {
    "in deviation bounds" - {
      ...
      for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
        ...
        dex1.api.getReservedBalanceByPK(alice) should matchTo(Map(assetPair.amountAsset -> 300000000000L, feeAsset -> 7 * matcherFee))
        dex1.api.getReservedBalanceByPK(bob) should matchTo(Map(assetPair.priceAsset -> 300300000L))
    ...
    "out of deviation bounds" - {
      ...
      "-- too high" - {
        for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
          ...
          dex1.api.getReservedBalanceByPK(alice) should matchTo(Map(assetPair.amountAsset -> 1000.waves, feeAsset -> 2 * matcherFee))
        ...
        s"$wavesUsdPair" in {
          ...
          dex1.api.getReservedBalanceByPK(alice) shouldBe Map(wavesUsdPair.amountAsset -> 1000.waves, feeAsset -> 2 * 300)
  ...
  "orders fee is" - {
    "in deviation bounds" - {
      for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
        ...
        dex1.api.getOrderBook(assetPair).bids shouldBe List(HttpV0LevelAgg(1000.waves, 700000))
      ...
      s"$wavesUsdPair" in {
        ...
        placeAndAwaitAtDex(aliceOrder2)
        dex1.api.getOrderBook(wavesUsdPair).bids shouldBe List(HttpV0LevelAgg(1000.waves, 700))
  ...
  private def cancelAll(xs: KeyPair*): Unit = xs.foreach(dex1.api.cancelAllOrdersWithSig(_))
