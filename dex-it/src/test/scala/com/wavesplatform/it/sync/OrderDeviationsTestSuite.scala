    ...
    "out of deviation bounds" - {
      "-- too low" - {
        for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
          ...
          dex1.api.orderBook(assetPair).bids shouldBe List(LevelAgg(1000.waves, 300000))
        ...
        s"$wavesUsdPair" in {
          ...
          dex1.api.orderBook(wavesUsdPair).bids shouldBe List(LevelAgg(1000.waves, 300))
      ...
      "-- too high" - {
        for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
          ...
          dex1.api.orderBook(assetPair).asks shouldBe List(LevelAgg(1000.waves, 500000))
        ...
        s"$wavesUsdPair" in {
          ...
          dex1.api.orderBook(wavesUsdPair).asks shouldBe List(LevelAgg(1000.waves, 500))
  ...
  "orders fee is" - {
    ...
    "out of deviation bounds" - {
      for (assetPair <- Seq(wavesBtcPair, ethWavesPair, scriptAssetsPair)) s"$assetPair" in {
        ...
        dex1.api.orderBook(assetPair).bids shouldBe List(LevelAgg(1000.waves, 1200000))
      ...
      s"$wavesUsdPair" in {
        ...
        dex1.api.orderBook(wavesUsdPair).bids shouldBe List(LevelAgg(1000.waves, 1200))
