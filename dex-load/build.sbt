...
TaskKey[Unit]("generateAmmo") := (Compile / runMain)
  .toTask(
  ...
  .value
TaskKey[Unit]("generateFeeder") := (Compile / runMain)
  .toTask(
  ...
  .value
TaskKey[Unit]("checkLeaps") := (Compile / runMain)
  .toTask(
  ...
  .value
TaskKey[Unit]("checkUpdates") := (Compile / runMain)
  .toTask(
