...
case class ApiOrderRestrictions(@ApiModelProperty(dataType = "string", example = "0.001") stepAmount: Double,
...
object ApiOrderRestrictions {

  implicit val doubleFormat: Format[Double]                              = json.stringAsDoubleFormat
  implicit val apiOrderRestrictionsFormat: OFormat[ApiOrderRestrictions] = Json.format[ApiOrderRestrictions]

  def fromSettings(settings: OrderRestrictionsSettings): ApiOrderRestrictions =
