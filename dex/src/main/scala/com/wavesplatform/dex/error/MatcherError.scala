...
case class UserPublicKeyIsNotValid(reason: String = "Provided user public key is not correct") extends MatcherError(account, pubKey, broken, e"Provided public key in not correct, reason: ${Symbol("reason") -> reason}")
