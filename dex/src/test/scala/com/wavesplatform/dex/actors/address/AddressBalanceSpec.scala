...
//          val futureTxIds = updated.futureTxs.contains(txId)
//
...
//              .copy(futureTxs = orig.futureTxs + txId)
//              .withExecuted(txId.some, NegativeMap(txReserve.inverse()))
//            updated.futureTxs shouldNot contain(txId)
...
//        updated.futureTxs should contain(txId)
//        affected shouldBe empty
//      }
//    }
//  }
