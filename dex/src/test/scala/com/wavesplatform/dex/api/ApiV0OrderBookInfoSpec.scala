...
//
//class ApiV0OrderBookInfoSpec extends AnyFreeSpec with Matchers with DiffMatcherWithImplicits {
//
//  private val json =
//    """{
//  "restrictions" : {
...
//}"""
//
//  private val orderBookInfo = ApiV0OrderBook(
//    timestamp =
//    restrictions = Some(
...
//    "serialization" in {
//      Json.parse(json).as[ApiV0OrderBook] should matchTo(orderBookInfo)
//    }
//
//    "deserialization" in {
