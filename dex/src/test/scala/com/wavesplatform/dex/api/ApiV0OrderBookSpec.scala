...
class ApiV0OrderBookSpec extends AnyFreeSpec with Matchers with DiffMatcherWithImplicits {
  ...
  private val orderBookV0Normalized     = ApiV0OrderBook(0, assetPair, bids, asks)
