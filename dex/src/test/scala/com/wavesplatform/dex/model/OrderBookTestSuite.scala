...
class OrderBookTestSuite
    ...
    def appendAll[T](xs: Seq[T])(f: (OrderBook, T) => OrderBookUpdates): OrderBookUpdates =
      xs.foldLeft(OrderBookUpdates(ob, Queue.empty[Event], LevelAmounts.empty, None)) {
        case (currentUpdates, x) =>
          ...
          newUpdates.copy(
            events = currentUpdates.events ++ newUpdates.events,
            levelChanges = currentUpdates.levelChanges |+| newUpdates.levelChanges
          )
      }
    ...
    val gen = Gen
      ...
      .map {
        case (tickSize, askPrices, bidPrices) =>
          ...
          (tickSize, OrderBook.empty.appendAllLimit(asks ++ bids, nowTs, tickSize = tickSize).orderBook)
      }

    forAll(gen) {
      case (tickSize, ob) =>
        for {
          (level, orders) <- ob.bids.iterator
          order <- orders
        } {
  ...
  "place matchable orders with and without tick size" in {
    ...
    withClue("matchable orders should not be matched with tick size:\n") {
      val OrderBookUpdates(ob, events, _, _) =
        ob1.appendAllAccepted(List(counterSellOrder, submittedBuyOrder), nowTs, tickSize = normalizedTickSize)
  ...
  "partially execute order with price > 1 and zero fee remaining part " in {
    ...
    val OrderBookUpdates(ob, _, _, _) = OrderBook.empty.appendAllLimit(List(ord1, ord2, ord3), nowTs)
  ...
  "create OrderExecuted events with different executed fee for maker and taker" in {
    ...
    forAll(
      Table(
        ...
        (1.waves, 1.waves, false, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.003, Waves, 0.003.waves, 0.003.waves),
        // orders have sufficient fee = 0.009.waves
        (1.waves, 1.waves, false, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.009, Waves, 0.001.waves, 0.009.waves),
        /** small maker - big taker */
        // like in old good times
        (2.waves, 10.waves, false, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.003, Waves, 0.003.waves, 0.0006.waves),
        // orders have sufficient fee = 0.009.waves
        (2.waves, 10.waves, false, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.009, Waves, 0.001.waves, 0.0018.waves),
        /** big maker - small taker */
        // like in old good times
        (10.waves, 2.waves, false, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.003, Waves, 0.0006.waves, 0.003.waves),
        // orders have sufficient fee = 0.009.waves
        (10.waves, 2.waves, false, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.009, Waves, 0.0002.waves, 0.009.waves),
        /** symmetric, taker is market */
        // like in old good times
        (1.waves, 1.waves, true, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.003, Waves, 0.003.waves, 0.003.waves),
        // orders have sufficient fee = 0.009.waves
        (1.waves, 1.waves, true, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.009, Waves, 0.001.waves, 0.009.waves),
        /** small maker - big market taker */
        // like in old good times
        (2.waves, 10.waves, true, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.003, Waves, 0.003.waves, 0.0006.waves),
        // orders have sufficient fee = 0.009.waves
        (2.waves, 10.waves, true, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.009, Waves, 0.001.waves, 0.0018.waves),
        /** big maker - small market taker */
        // like in old good times
        (10.waves, 2.waves, true, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.003, Waves, 0.0006.waves, 0.003.waves),
        // orders have sufficient fee = 0.009.waves
        (10.waves, 2.waves, true, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.009, Waves, 0.0002.waves, 0.009.waves),
        /** symmetric, taker fee in ETH */
        // like in old good times
        (1.waves, 1.waves, false, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.00001703, eth, 0.003.waves, 0.00001703.eth),
        // orders have sufficient fee = 0.009.waves = 0.00005109.eth
        (1.waves, 1.waves, false, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.00005109, eth, 0.001.waves, 0.00005109.eth),
        /** small maker - big taker, taker fee in ETH */
        // like in old good times
        (2.waves, 10.waves, false, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.00001703, eth, 0.003.waves, 0.00000340.eth),
        // orders have sufficient fee = 0.009.waves = 0.00005109.eth
        (2.waves, 10.waves, false, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.00005109, eth, 0.001.waves, 0.00001021.eth),
        /** big maker - small taker, taker fee in ETH */
        // like in old good times
        (10.waves, 2.waves, false, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.00001703, eth, 0.0006.waves, 0.00001703.eth),
        // orders have sufficient fee = 0.009.waves = 0.00005109.eth
        (10.waves, 2.waves, false, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.00005109, eth, 0.0002.waves, 0.00005109.eth),
        /** symmetric, taker is market, taker fee in ETH */
        // like in old good times
        (1.waves, 1.waves, true, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.00001703, eth, 0.003.waves, 0.00001703.eth),
        // orders have sufficient fee = 0.009.waves = 0.00005109.eth
        (1.waves, 1.waves, true, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.00005109, eth, 0.001.waves, 0.00005109.eth),
        /** small maker - big market taker, taker fee in ETH */
        // like in old good times
        (2.waves, 10.waves, true, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.00001703, eth, 0.003.waves, 0.00000340.eth),
        // orders have sufficient fee = 0.009.waves = 0.00005109.eth
        (2.waves, 10.waves, true, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.00005109, eth, 0.001.waves, 0.00001021.eth),
        /** big maker - small market taker, taker fee in ETH */
        // like in old good times
        (10.waves, 2.waves, true, DynamicSettings(0.003.waves, 0.003.waves), 0.003.waves, 0.00001703, eth, 0.0006.waves, 0.00001703.eth),
        // orders have sufficient fee = 0.009.waves = 0.00005109.eth
        (10.waves, 2.waves, true, DynamicSettings(0.001.waves, 0.009.waves), 0.009.waves, 0.00005109, eth, 0.0002.waves, 0.00005109.eth)
      )
      // format: off
